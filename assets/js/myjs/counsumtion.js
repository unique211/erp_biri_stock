    ...
    $('#search').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var batch='';
                $('#tfoot').html('');
                var sumofnetbiri=0;var sumoflev=0;var sumoftob=0;var sumofbly=0;var sumofwhy=0;var sumoffil=0;
                for (var i = 1; i < data.length; i++) {
                    ...
                    tbody += '<tr>' +
                        '<td>' + dt + '</td>' +
                        '<td>' + data[i].batch + '</td>' +
                        '<td class="texes">' + data[i].netbiri + '</td>' +
                        '<td class="texes">' + data[i].leaves + '</td>' +
                        '<td class="texes">' + data[i].tobacco + '</td>' +
                        '<td class="texes">' + data[i].blackyarn + '</td>' +
                        '<td class="texes">' + data[i].whiteyarn + '</td>' +
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        htm = '';
                        //htm+=;
                        var sumofasb = 0; var sumofleaves = 0; var sumoftobacco = 0;var sumofblackyarn =0;var sumofwhiteyarn =0;var sumoffilter =0;
                        for (i = 0; i < data.length; i++) {
                            ...
                            htm += '<tr class="names"><td>Sub Total--</td>' +
                                ...
                                '<td class="texes">' + data[i].sumnetbiri + '</td>' +
                                '<td class="texes">' + data[i].sumleaves + '</td>' +
                                '<td class="texes">' + data[i].sumtobacco + '</td>' +
                                '<td class="texes">' + data[i].sumblackyarn + '</td>' +
                                '<td class="texes">' + data[i].sumwhiteyarn + '</td>' +
                                '<td class="texes">' + data[i].sumfilter + '</td>' +
                                '<td></td></tr>';
                             console.log('asal:'+data[i].sumnetbiri);
                        }
                        htm += '<tr class="names "><td>Grand Total--</td><td></td>' +
                            '<td class="texes">' + sumofasb.toFixed(3) + '</td>' +
                            '<td class="texes">' + sumofleaves.toFixed(3) + '</td>' +
                            '<td class="texes">' + sumoftobacco.toFixed(3) + '</td>' +
                            '<td class="texes">' + sumofblackyarn.toFixed(3) + '</td>' +
                            '<td class="texes">' + sumofwhiteyarn.toFixed(3) + '</td>' +
                            '<td class="texes">' + sumoffilter.toFixed(3) + '</td>' +
