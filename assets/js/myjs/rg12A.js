    ...
    $.ajax({
        ...
        success: function(data) {
           ...
           if(data.length>0){
                    ...
                    closeingloosepcsum=(parseFloat(closeingloosepcsum)+(parseFloat(data[lengthdata-1].loosepcs))).toFixed(3);
                    closeinglableboxsum=(parseFloat(closeinglableboxsum)+(parseFloat(data[lengthdata-1].opninglable)));
                    closeinglablepcsum=(parseFloat(closeinglablepcsum)+(parseFloat(data[lengthdata-1].alltotal))).toFixed(3);
