$(document).ready(function(){
    ...
    $('#search').click(function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var nm='';var tobacco=0;var leaves=0; var black_yarn=0; var white_yarn=0;var filter=0;
    ...
    function Total(){
      ...
      html='';
        ...
        var r = r1.length;var tob =0;var lev=0;var by=0;var wy=0;var fil=0;
        var stob=0;var slev=0;var sby=0;var swy=0;sfil=0;
            for (var i = 0; i < r; i++) {
        ...
        '<td></td>'+
        '<td></td>'+
        '<td>'+stob.toFixed(3)+'</td>'+
        '<td>'+slev.toFixed(3)+'</td>'+
        '<td>'+sby.toFixed(3)+'</td>'+
        '<td>'+swy.toFixed(3)+'</td>'+
        '<td>'+sfil.toFixed(3)+'</td>'+
        '</tr>';
        $('#tfoot').html(html);
    }
});