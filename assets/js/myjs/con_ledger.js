    ...
    $('#search').on('click',function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var tasb=0;var tchkg=0; var tchpcs=0;var tleave=0; var ttobacco=0;var tbly=0;var twhy=0;var tfilter=0;
                //variables for closing balance
                var cleaves=0;var a=0;var oleave=0;var crleaves=0;var ls=0;var tleaves=0;var total=0;
                var flag=0;var row=0;var batches='';var table='';var btc=data[0].batch;var row1=0;var openingbalance='';
                var sumofasb=0;var sumofchkg=0;var sumofchpcs=0;var sumoftob=0;var sumoflev=0;var sumofbly=0;var sumofwhy=0;
                var sumoffil=0;var optob=0;var oplev=0;var opbly=0;var opwhy=0;var opfil=0;var nbiri=0;var chbirikg=0;
                var chbiripcs=0;var grosstotal=0;var lev=0;var tob=0;var blsutta=0;var whsutta=0;var bag=0;var dice=0;var tsort=0;var advance=0;var pf=0;var sumoftotal=0;var finalTot=0;var here=0;var check=0;var totallev=0;var totalbly=0;var totalfil=0;var totaltob=0;var totalwhy=0;
                ...
                for(var i=0;i<data.length;i++){
                    if(data[i].batch != null){
                        ...
                        if(btc == data[i].batch ){//|| btc1 == data[i].batch
                            ...
                            sumofasb=0;sumofchkg=0;sumofchpcs=0;sumoflev=0;sumoftob=0;sumofbly=0;sumofwhy=0;sumoffil=0;
                            sumofasb=parseFloat(sumofasb)+parseFloat(data[i].asalbidi);
                            sumofchkg=parseFloat(sumofchkg)+parseFloat(data[i].chatbidikgs);
                            sumofchpcs=parseFloat(sumofchpcs)+parseFloat(data[i].chatbidipcs);
                            sumoflev=parseFloat(sumoflev)+parseFloat(data[i].lev);
