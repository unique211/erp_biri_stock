...
?>
 <?php foreach($sidebar as $val){ 
	  ...
	  if(($val->menu_id==5 && $val->submenu_id==29) && ( $val->create_p==1 || $val->delete_p==1 || $val->edit_p==1 || $val->read_p	==1 ||  $val->export_p	==1)){
                                            ...
                                            <table id="dataTable" class="table table-striped table-bordered">
                                                ...
                                                <thead id="thead">
                                                    <tr>
                                                        ...
                                                        <th colspan="2" style="text-align:center;"><b>
                                                                <font color="black"> Purchase</font>
                                                            </b> </th>
                                                        <th colspan="2" style="text-align:center;"><b>
                                                                <font color="black">Consumption</font>
                                                            </b></th>
                                                        <th colspan="2" style="text-align:center;"><b>
                                                                <font color="black">Sales</font>
                                                            </b></th>
                                                        <th colspan="2" style="text-align:center;"><b>
                                                                <font color="black">Shortage</font>
                                                            </b></th>
                                                        <th colspan="2" style="text-align:center;"><b>
