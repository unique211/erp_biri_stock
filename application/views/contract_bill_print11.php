	...
	$handlingd=$value['handlingd'];
		...
		$i=$i+1; 
			...
			foreach($companydata as $value){
                ...
                $table->easyCell("Bill \n  $name  \n$address", 'align:C; colspan:12;font-style:B;font-size:10;  border:LRT;');
            ...
            //     $table->printRow();
                ...
                $table->easyCell("1. Being Biri Making Charges", 'border:LR; align:L; font-size:8; font-style:B;');
                ...
                $table->easyCell("2.HRA", 'border:LR; align:L; font-size:8; font-style:B;');
                $table->easyCell("$netbiri", 'border:LR; align:C; font-size:8; font-style:B;');
                ...
                $table->easyCell("3.Transporting,Handling And Other Charges Of Contractor", 'border:LR; align:L; font-size:8; font-style:B;');
                $table->easyCell("$netbiri", 'border:LR; align:C; font-size:8; font-style:B;');
