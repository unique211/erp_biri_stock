...
?>
 <?php foreach($sidebar as $val){ 
	  ...
	  if(($val->menu_id==4 && $val->submenu_id==18) && ( $val->create_p==1 || $val->delete_p==1 || $val->edit_p==1 || $val->read_p	==1 ||  $val->export_p	==1)){
								   ...
								   <form id="master_form" name="master_form">
									...
									<div class="col-sm-4">
                                            ...
                                            <div class="input-group date doj" data-provide="datepicker">
												<input type="text" class="form-control input-sm placeholdesize datepicker"  id="edate" name="edate" placeholder="Entry Date" readonly required  >
									...
									<div class="col-sm-4">
                                             <div class="form-group">
                                            <input type="text" class="form-control input-sm placeholdesize" id="qty" name="qty" placeholder="0.000" required  >
                                        </div>
                                    </div>
...
var export_p="<?php  echo $export_p; ?>";
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/weekly_adjustment.js"></script>
