         ...
         <div id="top-nav" class="fixed skin-6">
            <a href="#" class="brand">
                <span><img src="<?php echo base_url(); ?>assets/img/wadhwa.png"  alt="" /></span>
            ...
            <ul class="nav-notification clearfix">
                ...
                <li class="profile dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a tabindex="-1" class="main-link" href="<?php echo base_url(); ?>wadhawa/index"><i class="fa fa-lock fa-lg"></i> Log out</a></li>
                    </ul>
                </li>
            </ul>
        </div><!-- /top-nav-->
